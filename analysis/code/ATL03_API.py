...
def main(reef, username, password):
    ...
    if not os.path.exists(reef.icesat_path):
        os.mkdir(reef.icesat_path)

    url_list = cmr_search(short_name, version, time_start, time_end,
                bounding_box=bounding_box,
                polygon=polygon, filename_filter=filename_filter)

    cmr_download(url_list, username, password, reef.icesat_path)


if __name__ == '__main__':

    main('data','reef_name<replace>')
